      ...
      const diagramPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\diagram-1744488670979.png";
      const imageBuffer = fs.readFileSync(diagramPath);
      const base64Image = imageBuffer.toString('base64');
      
      // Define render output path
      const renderPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744488670979.png";
      ...
      async function generateAndRenderScene() {
        try {
          ...
          # Setup rendering
          import bpy
          bpy.context.scene.render.filepath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744488670979.png"
