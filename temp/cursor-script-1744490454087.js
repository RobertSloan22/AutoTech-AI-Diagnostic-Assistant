      ...
      const diagramPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\diagram-1744490454087.png";
      const imageBuffer = fs.readFileSync(diagramPath);
      const base64Image = imageBuffer.toString('base64');
      
      // Define render output path
      const renderPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744490454087.png";
      ...
      async function generateModel() {
        try {
          ...
          print("Setting render filepath to: C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744490454087.png")
          bpy.context.scene.render.filepath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744490454087.png"
      ...
      generateModel().then(success => {
        ...
        if (success) {
          console.log("Checking for render file:", "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744490454087.png");
          if (fs.existsSync("C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744490454087.png")) {
