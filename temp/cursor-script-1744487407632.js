...
import { cursor } from '@cursor/cursor-api';

// Read the diagram image
const diagramPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\diagram-1744487407632.png";
const imageBuffer = fs.readFileSync(diagramPath);
const base64Image = imageBuffer.toString('base64');

// Define render output path
const renderPath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744487407632.png";
...
async function generateAndRenderScene() {
  try {
    ...
    # Setup rendering
    import bpy
    bpy.context.scene.render.filepath = "C:\\Users\\rstec\\collaborative-editor\\mern-chat-app\\temp\\render-1744487407632.png"
